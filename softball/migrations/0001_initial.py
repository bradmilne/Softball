...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('softball_statline', (
            ...
            ('at_bats', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
            ('singles', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
            ('doubles', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
            ('triples', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
            ('homeruns', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
            ('runs', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
            ('rbis', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
            ('rboe', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
        ))
    ...
    models = {
        ...
        'softball.statline': {
            ...
            'at_bats': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
            'doubles': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
            'homeruns': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['softball.Player']"}),
            'rbis': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
            'rboe': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
            'runs': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
            'season_name': ('django.db.models.fields.CharField', [], {'max_length': '12'}),
            'singles': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
            'triples': ('django.db.models.fields.IntegerField', [], {'max_length': '2'})
        }
    }
