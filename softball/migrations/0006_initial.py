...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('softball_statline', (
            ...
            ('avg', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=3, blank=True)),
        ))
    ...
    models = {
        ...
        'softball.statline': {
            ...
            'avg': ('django.db.models.fields.DecimalField', [], {'max_digits': '3', 'decimal_places': '3', 'blank': 'True'}),
